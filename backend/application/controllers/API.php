...
public function registerUser_post(){
    ...
    if($params['role']){
     ...
     $result = $this->user_model->register($fname,$lname,$mobile,$alternate_mobile,$dob,$email,$role,$status,$current_address,$permanent_address,$image);
...
$result = $this->user_model->updateUserProfile($id,$image);
  $this->response($result, 200); 
}
